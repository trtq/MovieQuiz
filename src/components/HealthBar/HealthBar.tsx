...
import { HealthHeart } from '_/components/HealthHeart';
import { useStore } from '_/stores/useStore';
import { DIFFICULTIES } from '_/utils/difficulties';
...
export const Healthbar = observer(() => {
  ...
  const healthMap: boolean[] = useMemo(() => {
    ...
    for (let i = 1; i <= DIFFICULTIES[difficuty].health; i++) healthPool.push(i > health);
    return healthPool;
  }, [health, difficuty]);
  return (
    <Container>
